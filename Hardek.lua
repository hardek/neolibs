-- Hardek's neobot library 0.9.5
print('Hardek Library Version: 0.9.5')
...
creatures_table = {
    ...
    {name = "arkhothep (creature)", exp = 0, hp = 1, ratio = 0.000, maxdmg = 5000, deathmod = 100, firemod = 100, energymod = 100, earthmod = 100, icemod = 100, holymod = 100, physicalmod = 100},
    {name = "armenius (creature)", exp = 0, hp = 1, ratio = 0.000, maxdmg = 0, deathmod = 100, firemod = 100, energymod = 100, earthmod = 100, icemod = 100, holymod = 100, physicalmod = 100},
    ...
    {name = "avalanche (creature)", exp = 305, hp = 550, ratio = 0.555, maxdmg = 250, deathmod = 100, firemod = 70, energymod = 110, earthmod = 0, icemod = 0, holymod = 100, physicalmod = 100},
    ...
    {name = "blood crab (underwater)", exp = 180, hp = 320, ratio = 0.562, maxdmg = 111, deathmod = 100, firemod = 0, energymod = 105, earthmod = 0, icemod = 0, holymod = 100, physicalmod = 99},
    ...
    {name = "butterfly (blue)", exp = 0, hp = 2, ratio = 0.000, maxdmg = 0, deathmod = 100, firemod = 100, energymod = 100, earthmod = 100, icemod = 100, holymod = 100, physicalmod = 100},
    {name = "butterfly (purple)", exp = 0, hp = 2, ratio = 0.000, maxdmg = 0, deathmod = 100, firemod = 100, energymod = 100, earthmod = 100, icemod = 100, holymod = 100, physicalmod = 100},
    {name = "butterfly (red)", exp = 0, hp = 2, ratio = 0.000, maxdmg = 0, deathmod = 100, firemod = 100, energymod = 100, earthmod = 100, icemod = 100, holymod = 100, physicalmod = 100},
    ...
    {name = "gamemaster (creature)", exp = 0, hp = 1, ratio = 0.000, maxdmg = 100, deathmod = 0, firemod = 0, energymod = 0, earthmod = 0, icemod = 0, holymod = 0, physicalmod = 0},
    ...
    {name = "kongra (anti-botter)", exp = 0, hp = 20000, ratio = 0.000, maxdmg = 90, deathmod = 100, firemod = 100, energymod = 100, earthmod = 100, icemod = 100, holymod = 100, physicalmod = 100},
    ...
    {name = "merlkin (anti-botter)", exp = 900, hp = 20000, ratio = 0.045, maxdmg = 10, deathmod = 100, firemod = 100, energymod = 100, earthmod = 100, icemod = 100, holymod = 100, physicalmod = 100},
    ...
    {name = "pythius the rotten (creature)", exp = 7000, hp = 9000, ratio = 0.778, maxdmg = 1250, deathmod = 0, firemod = 100, energymod = 0, earthmod = 0, icemod = 100, holymod = 100, physicalmod = 100},
    ...
    {name = "slime (creature)", exp = 160, hp = 150, ratio = 1.067, maxdmg = 107, deathmod = 100, firemod = 110, energymod = 110, earthmod = 0, icemod = 80, holymod = 100, physicalmod = 100},
    ...
    {name = "thief (creature)", exp = 5, hp = 60, ratio = 0.083, maxdmg = 32, deathmod = 100, firemod = 100, energymod = 100, earthmod = 100, icemod = 100, holymod = 100, physicalmod = 100},
    ...
    {name = "tortoise (anti-botter)", exp = 0, hp = 1, ratio = 0.000, maxdmg = 100, deathmod = 100, firemod = 110, energymod = 100, earthmod = 100, icemod = 100, holymod = 100, physicalmod = 100},
    ...
    {name = "yalahari (creature)", exp = 5, hp = 150, ratio = 0.033, maxdmg = 0, deathmod = 0, firemod = 100, energymod = 100, earthmod = 0, icemod = 100, holymod = 100, physicalmod = 0},
